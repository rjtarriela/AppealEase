<div class="card mb-4">
    ...
    <div class="card-body">
        <table id="judgesTable" class="table">
            ...
            <tbody>
                @if ($litigants->isEmpty())
                    <tr>
                        <td colspan="4" class="text-center">No records of Litigants</td>
                    </tr>
                @else
                    @foreach ($litigants as $judge)
                        <tr class="text-center">
                            <td class="align-content-center">{{ $judge->name }}</td>
                            <td class="align-content-center">{{ $judge->email }}</td>
                            <td class="align-content-center">{{ $judge->atty_number }}</td>
