            ...
            <div class="modal-body">
                <ol style="text-align: left">
                    @php
                        ...
                        $uploads = [
                            'pleading' => json_decode($case->case->pleading, true),
                            'evidences' => json_decode($case->case->evidences, true),
                            'verification' => json_decode($case->case->verification, true),
                            'certificate' => json_decode($case->case->certificate, true),
                            'judicial_affidavit' => json_decode($case->case->judicial_affidavit, true),
                            'notice_of_appeal' => json_decode($case->case->notice_of_appeal, true),
                            'documents' => json_decode($case->case->documents, true),
                            'memoranda' => json_decode($case->case->memoranda, true),
                            'other_files' => json_decode($case->case->other_files, true),
                        ];
                    @endphp
