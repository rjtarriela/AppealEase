            ...
            <div class="modal-body">
                ...
                <table>
                    <tr>
                        ...
                        <td style="text-align: left">: {{ $case->case->name_of_filing_party }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Litigant Name</td>
                        <td style="text-align: left">: {{ $case->case->litigant_name }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Email Address</td>
                        <td style="text-align: left">: {{ $case->case->email_address }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Contact Number</td>
                        <td style="text-align: left">: {{ $case->case->contact_number }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Roll Number</td>
                        <td style="text-align: left">: {{ $case->case->license_number }}</td>
                    </tr>
                </table>
            </div>
