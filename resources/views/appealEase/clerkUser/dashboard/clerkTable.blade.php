                        ...
                        <tr class="text-center">
                            ...
                            <td class="align-content-center">
                                ...
                                <form action="{{ url('/dashboard/cases/randomize/' . $case->id) }}" method="POST"
                                    ...
                                    @csrf
                                    {{-- <button type="submit" class="btn btn-outline-primary edit-btn"
                                        ...
                                        {{-- {{ session('randomDivision') ? 'Sent to Division ' . session('randomDivision') : 'Raffle' }} --}}

                                        {{-- {{ $case->division ? 'Sent to Division ' . $case->division : 'Raffle' }} --}}
                                    {{-- </button> --}}

                                    @if ($case->division && $case->statusRandom == 'assigned')
                                        <button class="btn btn-primary" disabled>Division Assigned to
                                            {{ $case->division }}
                                        </button>
                                    @else
